            ...
            <div className="bg-[#f5f7fa] background-img text-[#f4f8fe] flex flex-col min-h-screen">
                ...
                <header className="bg-[#14102a] text-white p-4 fixed top-0 left-0 right-0 z-50 shadow-md">
                    <div className="flex items-center justify-between">
                        ...
                        {/* Иконки справа - скрываем при открытом поиске */}
                        {/* Иконки справа */}
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <span
                                        className="absolute -top-1 -right-1 bg-[#a45cd4] text-white text-xs font-bold rounded-full h-4 w-4 flex items-center justify-center">
                    3
                  </span>
                                </button>
                            </div>
                            ...
                            {!isSearchOpen && !isNotificationsOpen && (
                                <Link to="/profile">
                                    <div
                                        className="w-8 h-8 rounded-full bg-[#233e85] overflow-hidden hover:scale-105 transition-transform">
                                        <img
                ...
                {/* Панель уведомлений */}
                <NotificationsPanel isOpen={isNotificationsOpen} onClose={handleCloseAllPanels}/>

                {/* Основной контент (скрываем при открытом поиске) */}
                {!isSearchOpen && !isNotificationsOpen && (
